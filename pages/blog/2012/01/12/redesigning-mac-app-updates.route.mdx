...
Yes please! This would solve the problem that the [Sparrow Team was trying to solve](http://appleuserpro.com/linkedlist/sparrow-rejected-because-it-notifies-users-when-theres-an-update) (and which ultimately caused them to get rejected and re-submit the app update without that feature).
