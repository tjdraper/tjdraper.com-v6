...
What a sensationalist load of garbage. Beside the fact that as it stands right now iOS would never work well on a full size computer, there is the fact that you have to have a Mac running Snow Leopard to develop for iOS. If Apple let’s the Mac platform stagnate, its iOS platform will also stagnate.
